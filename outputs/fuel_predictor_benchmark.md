# Fuel-consumption prediction benchmark (2026-09-12T15:47:13Z)
...
| LightGBM | 2.436 | 2.109 | 2.652 | 0.9935 | 90.09 |
| MLP | 4.224 | 2.261 | 13.617 | 0.9597 | 27.35 |
| Tensor-train residual | 2.470 | 2.062 | 2.864 | 0.9934 | 0.18 |
| Quantum-inspired neural residual (QNN/QEPS) | 2.435 | 2.108 | 2.725 | 0.9934 | 23.65 |

**Quantum-inspired neural residual** wins on mean MAPE (2.435% vs. physics-only's 3.993%, a 1.559 percentage-point gap). See the provenance note above before treating this ranking as anything more than a demonstration that the benchmarking method works.
